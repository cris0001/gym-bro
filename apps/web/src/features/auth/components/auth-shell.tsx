...
export function AuthShell({ variant, children }: AuthShellProps) {
  ...
  return (
    <main className="flex min-h-dvh flex-col bg-[#2b2126] min-[800px]:grid min-[800px]:grid-cols-[1fr_380px] min-[800px]:bg-[#f6f3f0] lg:grid-cols-[1fr_440px] xl:grid-cols-[1fr_460px] 3xl:grid-cols-[1fr_620px] 4xl:grid-cols-[1fr_660px]">
      {/* Brand panel — a top band below 800px, the left column above it. Left padding
      ...
      <section className="relative flex min-h-[46dvh] flex-col overflow-hidden bg-[#2b2126] px-6 pt-14 pb-24 min-[800px]:min-h-dvh min-[800px]:px-10 min-[800px]:py-10 lg:px-14 xl:px-20 2xl:px-24 4xl:px-28">
        ...
        <div className="relative mt-auto mb-12 max-w-[440px] pt-10 min-[800px]:mt-0 min-[800px]:mb-0 min-[800px]:flex min-[800px]:pb-16 min-[800px]:max-w-[360px] min-[800px]:flex-1 min-[800px]:flex-col min-[800px]:justify-center min-[800px]:pt-0 xl:ml-[6%] xl:max-w-[420px] 2xl:ml-[9%] 2xl:max-w-[480px] 4xl:max-w-[560px]">
      ...
      {/* Form column — a light section overlapping the band below 800px, a plain
          column above it. */}
      <section className="relative -mt-16 flex-1 rounded-t-3xl bg-[#f6f3f0] px-6 pt-8 pb-[max(3rem,env(safe-area-inset-bottom))] min-[800px]:mt-0 min-[800px]:flex min-[800px]:items-center min-[800px]:rounded-none min-[800px]:px-8 min-[800px]:pt-10 lg:px-10">
